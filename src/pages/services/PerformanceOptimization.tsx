...
const PerformanceOptimization = () => {
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 px-4 bg-slate-50 dark:bg-slate-950/20">
        <div className="max-w-5xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-16 text-foreground">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="p-8 bg-white dark:bg-card">
              <CardContent className="pt-6">
                <div className="flex text-yellow-500 justify-start mb-4">
                  {"★".repeat(5)}
                </div>
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    <cite className="text-foreground font-semibold not-italic">Rajesh Kumar</cite>
                    <p className="text-sm text-muted-foreground">Manufacturing Director, Gurgaon</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card className="p-8 bg-white dark:bg-card">
              <CardContent className="pt-6">
                ...
                <blockquote className="text-lg text-muted-foreground mb-6">
                  "For the first time, our sales team tracks their own calls and conversions daily. No more end-of-month surprises—everyone knows where they stand."
                </blockquote>
                <div className="flex items-center">
                  <div className="w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mr-4">
                  ...
                  <div>
                    <cite className="text-foreground font-semibold not-italic">Anita Sharma</cite>
                    <p className="text-sm text-muted-foreground">Sales Director, Mumbai</p>
                  </div>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="mt-12 text-center">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="p-6">
                ...
                <p className="text-muted-foreground">Employee engagement with self-tracking</p>
              </div>
              <div className="p-6">
                <div className="text-3xl font-bold text-primary mb-2">60%</div>
                <p className="text-muted-foreground">Reduction in performance disputes</p>
              </div>
            </div>
          </div>
        </div>
