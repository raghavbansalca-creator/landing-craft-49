...
import { Building, ShoppingCart, Stethoscope, GraduationCap, Wrench, Truck, Banknote, Zap } from 'lucide-react';
const IndustriesSection = () => {
  ...
  return <div className="py-24 bg-gray-50">
        ...
        amount: 0.2
                    ...
                    {industries.map((industry, index) => <motion.div key={index} variants={itemVariants} whileHover={{
          y: -10,
          scale: 1.02,
          transition: {
            duration: 0.3
